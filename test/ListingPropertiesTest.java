...
public class ListingPropertiesTest {
    ...
    final Listing l1 = createListing.addListing(1,1,1,"ABC street",
            "ABC city","APARTMENT",2,2,new BigDecimal(123456), "test1", false);
    ...
    public void testSearchByPrice() {
        ArrayList<Listing> found1 = listingProperties.searchByPrice(new BigDecimal(123457), new BigDecimal(123455),1);
